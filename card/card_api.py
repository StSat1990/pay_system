from database.cardservice import add_card_db, exact_user_card_db, check_card_db, delete_card_db
...
@card_router.get('/exact-user-card')
async def get_exact_user_cards(user_id: int):
    result = exact_user_card_db(user_id)
